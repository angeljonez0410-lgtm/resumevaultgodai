      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
            <Bot className="w-6 h-6 text-[#f4c542]" /> AI Assistant
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            Your GPT-4o powered assistant for users, analytics, content, and more
          </p>
          <p className="text-xs text-slate-400 mt-2">
            Need Codex? Open the{" "}
            <Link href="/app/social-bot/code" className="font-semibold text-[#1e2d42] underline decoration-[#f4c542] underline-offset-2">
              Code Assistant
            </Link>{" "}
            inside Social Bot.
          </p>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h2 className="text-lg font-bold text-slate-800 mb-2">AI Assistant</h2>
