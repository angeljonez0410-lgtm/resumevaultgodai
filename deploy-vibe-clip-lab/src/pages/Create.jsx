...
import { Wand2, Mic, Shirt, RectangleHorizontal, Clock, ArrowRight, Sparkles } from 'lucide-react';
            ...
            <div className="rounded-2xl bg-slate-900/50 border border-white/5 p-6 space-y-4">
              ...
              <div className="pt-4 border-t border-white/5">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-emerald-300 font-semibold">Free generation</span>
                </div>
              </div>
            </div>
          </div>
